 ...
 * ('Log.add') tries to write a new line into the newest log file. (e.g.
 * /log_02-05-2016.log)
 * 
...
public class Log {
	...
	public static void log(LogLevel level, String message) {
		...
		try {
			...
			String writedString = "[" + (new Date()).toString() + "][" + level.name() + "]" + message
	...
	private static void exit(LogLevel level) {
		...
		case CRITICAL:
			Log.log(LogLevel.CRITICAL,
					"Critical error occurs!" + System.lineSeparator() + "Application will be terminated...");
			break;
		case STOP:
			Log.log(LogLevel.STOP,
					"Received stop-signal!" + System.lineSeparator() + "Application will be terminated...");
			break;
		}
		System.exit(0);
	}
